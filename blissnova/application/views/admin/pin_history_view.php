      ...
      <div class="card">
         <div class="card-body">
            ...
            <table id="example3" class="datatables-basic table table-bordered">
               ...
               <tbody>
                   <?php $his=$this->db->where('generated_by','admin')->where('status','Unused')->where('type',$type)->get('e_pin')->result_array(); 
                   $count=1;
                   foreach($his as $h){
                   ?>
                  <tr>
      ...
      <div class="card">
         <div class="card-body">
            ...
            <table id="example2" class="datatables-basic table table-bordered">
               ...
               <tbody>
                   <?php $hiss=$this->db->where('generated_by','admin')->where('type',$type)->where('status','Used')->get('e_pin')->result_array(); 
                   $countt=1;
                   foreach($hiss as $hi){
                   ?>
                  <tr>
