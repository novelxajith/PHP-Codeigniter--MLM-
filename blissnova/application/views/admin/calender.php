                    ...
                    <div
                      ...
                      <div class="offcanvas-body">
                        <!--<form class="event-form pt-0" id="eventForm" onsubmit="return false">-->
                           <?=form_open_multipart('admin/calenders'); ?> 
                          ...
                          <div class="form-floating form-floating-outline mb-4">
                            <select class="select2 select-event-label form-select" id="eventLabel" name="label">
                          ...
                          <div class="mb-3">
                            <label class="switch">
                              <input type="checkbox" class="switch-input allDay-switch" name="all"/>
