...
position: absolute;
    ...
    <div class="authentication-wrapper authentication-cover">
      ...
      <div class="authentication-inner row m-0">
        ...
        <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center justify-content-center p-5 pb-2">
          <img
            src="<?=BASEURL?>assets/img/illustrations/auth-two-steps-illustration-light.png"
          ...
          <img
            src="<?=BASEURL?>assets/img/illustrations/auth-cover-register-mask-light.png"
        ...
        <div
          ...
          <div class="w-px-400 mx-auto pt-5 pt-lg-0">
            <h4 class="mb-2 fw-semibold">OTP Verification 💬</h4>
            <p class="text-start mb-4">
              We sent a verification code to your Email. Enter the code from the email in the field below.
              <span class="fw-bold d-block mt-2">******@gmail.com</span>
            </p>
            <p class="mb-0 fw-semibold">Type your 6 digit security code</p>
            <form id="twoStepsForm" action="<?=BASEURL?>admin/otp_check" method="POST">
              <div class="mb-3">
                <!--<div-->
             ...
             <button class="btn btn-primary d-grid w-100 mb-3" type="submit">Verify OTP</button>
  ...
  <!-- / Content -->
    ...
    <!-- Vendors JS -->
    <script src="<?=BASEURL?>assets/vendor/libs/cleavejs/cleave.js"></script>
    ...
    <script src="<?=BASEURL?>assets/js/pages-auth-two-steps.js"></script>
  </body>
</html>
