      ...
      <div class="card">
         <div class="card-body">
            ...
            <table id="example3" class="datatables-basic table table-bordered">
               ...
               <tbody>
                   <?php $his=$this->db->where('deposit_id',$id)->where('status','Used')->get('e_pin')->result_array(); 
                   $count=1;
                   foreach($his as $h){
                   ?>
                  <tr>
      ...
      <div class="card">
         <div class="card-body">
            ...
            <table id="example2" class="datatables-basic table table-bordered">
               ...
               <tbody>
                   <?php $hiss=$this->db->where('deposit_id',$id)->where('status','Unused')->get('e_pin')->result_array(); 
                   $countt=1;
                   foreach($hiss as $hi){
                   ?>
                  <tr>
