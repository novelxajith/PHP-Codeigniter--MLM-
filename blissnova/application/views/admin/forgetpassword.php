    ...
    <div class="authentication-wrapper authentication-cover">
      ...
      <div class="authentication-inner row m-0">
        ...
        <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center justify-content-center p-5 pb-2">
          <img
            src="<?=BASEURL?>assets/img/illustrations/auth-forgot-password-illustration-light.png"
            class="auth-cover-illustration w-100"
            alt="auth-illustration"
            data-app-light-img="illustrations/auth-forgot-password-illustration-light.png"
            data-app-dark-img="illustrations/auth-forgot-password-illustration-dark.png" />
          <img
            src="<?=BASEURL?>assets/img/illustrations/auth-cover-forgot-password-mask-light.png"
        ...
        <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4">
          <div class="w-px-400 mx-auto">
            ...
            <p class="mb-4">Enter your email and we'll send you instructions to reset your password</p>
             <form id="formAuthentication" class="mb-3" action="<?=BASEURL?>admin/forgetpassword" method="POST">
            ...
            <div class="text-center">
              <a href="<?=BASEURL?>admin/index" class="d-flex align-items-center justify-content-center">
