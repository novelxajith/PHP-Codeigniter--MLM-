      ...
      <div class="col-xl-8 col-lg-7 col-md-7">
        ...
        <div class="col-12 col-xl-6 col-md-12">
                <div class="card" style="width:800px;">
                    ...
                    <?php $log_date=$this->db->select('log_date')->where('username',$this->session->userdata('ablisusername'))->get('user_role')->row()->log_date ;
                    $logout_date=$this->db->select('logout_date')->where('username',$this->session->userdata('ablisusername'))->get('user_role')->row()->logout_date ; 
                    
                    $log_date_last=$this->db->select('login_date_last')->where('username',$this->session->userdata('ablisusername'))->get('user_role')->row()->login_date_last ;
                    $logout_date_last=$this->db->select('logout_date_last')->where('username',$this->session->userdata('ablisusername'))->get('user_role')->row()->logout_date_last ; 
                    ?>
   ...
   <div class="modal-dialog modal-lg modal-simple modal-edit-user">
      <div class="modal-content p-3 p-md-5">
         <div class="modal-body py-3 py-md-0">
            ...
            <form id="editUserForm" class="row g-4" action="<?=BASEURL?>admin/user_profile_insert" method="post">
               <div class="row g-4">
                  <div class="col-sm-6">
                     <div class="form-floating form-floating-outline">
                        <input type="text" id="first-name" class="form-control" name="first_name" value="<?=$user_data['first_name']?>" placeholder="John">
                        <label for="first-name">First Name</label>
                     </div>
                  </div>
                  <div class="col-sm-6">
                     <div class="form-floating form-floating-outline">
                        <input type="text" id="last-name" class="form-control" value="<?=$user_data['last_name']?>" name="last_name" placeholder="Doe">
