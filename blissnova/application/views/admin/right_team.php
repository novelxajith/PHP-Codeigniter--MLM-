      ...
      <div class="col-md-12">
        <ul class="nav nav-pills flex-sm-row mb-4">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
               <a class="nav-link active" href="<?=BASEURL?>admin/right_team/<?=$user?>"
            ...
            <div class="nav-align-top mb-4 mt-3 ">
               ...
               <div class="tab-content">
                  <div class="tab-pane fade active show" id="navs-pills-top-home" role="tabpanel">
                     <h5 class="card-header">Right Team</h5>
                     <div class="card-datatable table-responsive pt-0">
                        <table id="example" class="datatables-basic table table-bordered" style="width:100%">
                           ...
                           <tbody>
                        <?php $right_user=$this->db->where('position','right')->where('parent_id',$user)->get('tree')->row_array();
                    					    if(!empty($right_user)){
                    					          $right=$this->db->like('team',$right_user['child_id'])->get('tree')->result_array();
                    					          
                    					           $right_team =$right;
                    					    }   
                    					    foreach($right_team as $key=>$team){
                        					        ...
                        					        $pack=$this->db->select_max('credit')->where('username',$user_data1['username'])->get('pin')->row()->credit; 
                  ...
                  <div class="tab-pane fade" id="navs-pills-top-profile" role="tabpanel">
                     ...
                     <div class="card-datatable table-responsive pt-0">
                        <table id="example2" class="datatables-basic table table-bordered" style="width:100%">
                           ...
                           <tbody>
                               <?php   
                                     $right_user1=$this->db->where('position','right')->where('parent_id',$wing2)->get('tree')->row_array();
                    					    if(!empty($right_user1)){
                    					          $right1=$this->db->like('team',$right_user1['child_id'])->get('tree')->result_array();
                    					          
                    					           $right_team1 = array();
                                                    $right_team1[0] = $right_user1;
                                                    foreach ($right1 as $keyy1) {
                                                        $right_team1[] = $keyy1;
                                                    }
                    					    }   
                    					    foreach($right_team1 as $key=>$team1){
                        					        ...
                        					        $pack1=$this->db->select_max('credit')->where('username',$user_data2['username'])->get('pin')->row()->credit; 
                  ...
                  <div class="tab-pane fade" id="navs-pills-top-messages" role="tabpanel">
                     ...
                     <div class="card-datatable table-responsive pt-0">
                        <table id="example3" class="datatables-basic table table-bordered" style="width:100%">
                           ...
                           <tbody>
                               <?php  
                                     $right_user2=$this->db->where('position','right')->where('parent_id',$wing3)->get('tree')->row_array();
                    					    if(!empty($right_user2)){
                    					          $right2=$this->db->like('team',$right_user2['child_id'])->get('tree')->result_array();
                    					          
                    					           $right_team2 = array();
                                                    $right_team2[0] = $right_user2;
                                                    foreach ($right2 as $keyy2) {
                                                        $right_team2[] = $keyy2;
                                                    }
                    					    }   
                    					    foreach($right_team2 as $key=>$team2){
                        					        ...
                        					        $pack2=$this->db->select_max('credit')->where('username',$user_data3['username'])->get('pin')->row()->credit; 
