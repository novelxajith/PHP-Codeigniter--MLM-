      ...
      <div class="authentication-wrapper authentication-cover">
        ...
        <div class="authentication-inner row m-0">
          ...
          <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center justify-content-center p-5 pb-2">
            <img
              src="<?=BASEURL?>assets/img/illustrations/auth-reset-password-illustration-light.png"
              class="auth-cover-illustration w-100"
              alt="auth-illustration"
              data-app-light-img="illustrations/auth-reset-password-illustration-light.png"
              data-app-dark-img="illustrations/auth-reset-password-illustration-dark.png" />
            <img
              src="<?=BASEURL?>assets/img/illustrations/auth-cover-reset-password-mask-light.png"
          ...
          <div
            ...
            <div class="w-px-400 mx-auto pt-5 pt-lg-0">
              ...
              <form id="formAuthentication" class="mb-3" action="<?=BASEURL?>admin/dashboard_reset_password" method="POST">
              <div class="mb-3 form-password-toggle">
               ...
               <button type="submit" class="btn btn-primary w-md">Set new password</button>
                <div class="text-center">
                  <a href="<?=BASEURL?>admin" class="d-flex align-items-center justify-content-center">
    ...
    form.addEventListener('submit', function(event) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          // redirect to the admin page after the confirmation dialog is closed
          setTimeout(function() {
            window.location.href = '<?=BASEURL?>admin';
          }, 3000); // wait for 10 seconds before redirecting
