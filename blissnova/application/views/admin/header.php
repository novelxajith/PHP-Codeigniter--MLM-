...
<html
   ...
   <body>
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
         ...
         <?php if($this->session->userdata('staffusertype')=='s'){
            $userpass="staff";
            }else{
              $userpass="admin";
            }?>
         <ul class="menu-inner py-1" >
            ...
            <li class="menu-item <?php if($page_name=="genealogy"){ echo "active";} ?>">
               <a href="<?=BASEURL?>admin/binary_tree" class="menu-link">
                  <i class="menu-icon tf-icons mdi mdi-sitemap"></i>
                  <i class=""></i>
                  <div data-i18n="Binary Tree">Binary Tree</div>
               </a>
            </li>
            <li class="menu-item <?php if($page_name=="team_management"){ echo "active";} ?>">
               <a href="<?=BASEURL?>admin/team_management" class="menu-link">
                  <i class="menu-icon tf-icons mdi mdi-account-multiple"></i>
                  <i class=""></i>
                  <div data-i18n="Team Management">Team Management</div>
               </a>
            </li>
            <li class="menu-item <?php if($page_name=="bank_management"){ echo "active";} ?>">
               <a href="<?=BASEURL?>admin/bank_management" class="menu-link">
            ...
            <?php
               $chatcount = $this->db->where('receiver_id',$this->session->userdata('ablisusername'))->where('status','unread')->count_all_results('chat_messages')+0;
               ?>
            <li class="menu-item <?php if($page_name=="chat"){ echo "active";} ?>">
               <a href="<?=BASEURL?>admin/chat" class="menu-link">
            ...
            <li class="menu-item <?php if($page_name=="usercredential"){ echo "active";} ?>">
               <a href="<?=BASEURL?>admin/usercredential" class="menu-link">
                  <i class="menu-icon tf-icons mdi mdi-account-tie"></i>
                  <i class=""></i>
                  <div data-i18n="User Credential">User Credential</div>
               </a>
            </li>
            </li>
            <li class="menu-item <?php if($page_name=="pinrequest"){ echo "active";} ?>">
               <a href="<?=BASEURL?>admin/pinrequest" class="menu-link">
                  <i class="menu-icon tf-icons mdi mdi-chart-timeline"></i>
                  <div data-i18n="Pin Mangement">Pin Mangement</div>
               </a>
            </li>
            <li class="menu-item <?php if($page_name=="pinrequesthistory"){ echo "active";} ?>">
               <a href="<?=BASEURL?>admin/pinrequesthistory" class="menu-link">
            ...
            <li class="menu-item">
               ...
               <a href="<?=BASEURL?>admin/kycrequest" class="menu-link">
            ...
            <li class="menu-item">
               <a href="<?=BASEURL?>admin/quote_history" class="menu-link">
                  <i class="menu-icon tf-icons mdi mdi-format-quote-close"></i>
                  <div data-i18n=" Quotes history"> Quotes history</div>
               </a>
            </li>
            <li class="menu-item <?php if($page_name=="activation"){ echo "active";} ?>">
               <a href="<?=BASEURL?>admin/activation" class="menu-link">
                  <i class="menu-icon tf-icons mdi mdi-check-circle"></i>
                  <div data-i18n="Activation">Activation</div>
               </a>
            </li>
            <li class="menu-item <?php if($page_name=="activationhistory"){ echo "active";} ?>">
               <a href="<?=BASEURL?>admin/activationhistory" class="menu-link">
                  <i class="menu-icon tf-icons mdi mdi-history"></i>
                  <div data-i18n="User history">User history</div>
               </a>
            </li>
            <!--<li class="menu-item <?php if($page_name=="payout_configuration"){ echo "active";} ?>">-->
            <!--   <a href="<?=BASEURL?>admin/payout_configuration" class="menu-link">-->
            <!--   <i class="menu-icon tf-icons mdi mdi-cash-check"></i>-->
            <!--    <div data-i18n="Payout Configuration">Payout Configuration</div>-->
            <!--   </a>-->
            <!--</li>-->
            <li class="menu-item <?php if($page_name=="payout_management"){ echo "active";} ?>">
               <a href="<?=BASEURL?>admin/payout_management" class="menu-link">
            ...
            <li class="menu-item <?php if($page_name=="left_active" || $page_name=="right_active"){ echo "active open";} ?>">
               <a href="" class="menu-link menu-toggle">
                  <i class="menu-icon tf-icons mdi mdi-trophy"></i>
                  <div data-i18n="Active Users">Active Users</div>
               </a>
               <ul class="menu-sub ">
                  <li class="menu-item <?php if($page_name=="left_active"){ echo "active";} ?>"><a href="<?=BASEURL?>admin/left_active"  class="menu-link">Left Active</a></li>
                  <li class="menu-item <?php if($page_name=="right_active"){ echo "active";} ?>"><a href="<?=BASEURL?>admin/right_active"  class="menu-link">Right Active</a></li>
               </ul>
            </li>
            <li class="menu-item <?php if($page_name=="prime_rank_achievers" || $page_name=="prime_achievers" || $page_name=="primeplus_achievers"){ echo "active open";} ?>">
               <a href="" class="menu-link menu-toggle">
                  <i class="menu-icon tf-icons mdi mdi-trophy"></i>
                  <div data-i18n="Incentive">Incentive</div>
               </a>
               <ul class="menu-sub ">
                  <li class="menu-item <?php if($page_name=="prime_rank_achievers"){ echo "active";} ?>"><a href="<?=BASEURL?>admin/team_incentive"  class="menu-link">Team Incentive</a></li>
                  <li class="menu-item <?php if($page_name=="prime_achievers"){ echo "active";} ?>"><a href="<?=BASEURL?>admin/affiliate_incentive"  class="menu-link">Affiliate Incentive</a></li>
                  <!--<li class="menu-item <?php if($page_name=="primeplus_achievers"){ echo "active";} ?>"><a href="<?=BASEURL?>user/primeplus_achievers"  class="menu-link">Plus Celing Achievers</a></li>-->
            ...
            <li class="menu-item <?php if($page_name=="calender"){ echo "active";} ?>">
               <a href="<?=BASEURL?>admin/calender" class="menu-link">
            ...
            <li class="menu-item <?php if($page_name=="shop_registration"){ echo "active";} ?>">
               <a href="<?=BASEURL?>admin/shop_registration" class="menu-link">
                  <i class="menu-icon tf-icons mdi mdi-pin"></i>
                  <div data-i18n="Shop Registration">Shop Registration</div>
               </a>
            </li>
                <li class="menu-item <?php if($page_name=="staff_panel"){ echo "active";} ?>">
               <a href="<?=BASEURL?>admin/staff_panel" class="menu-link">
               <i class="menu-icon tf-icons mdi mdi-pin"></i>
               <div data-i18n="Staff Panel">Staff Panel</div>
               </a>
            </li>
            <li class="menu-item <?php if($page_name=="invoice_list"){ echo "active";} ?>">
               <a href="<?=BASEURL?>admin/invoice_list" class="menu-link">
            ...
            <li class="menu-item <?php if($page_name=="dashboard_reset_password"){ echo "active";} ?>">
               <a href="<?=BASEURL?>admin/dashboard_reset_password" class="menu-link">
                  <i class="menu-icon tf-icons mdi mdi-lock-reset"></i>
                  <div data-i18n="Reset password">Reset Password</div>
               </a>
            </li>
            <li class="menu-item" >
               <a href="<?=BASEURL?>admin/logout_all_devices" class="menu-link">
      ...
      <nav
         ...
         <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end py-0">
                     ...
                     <li class="dropdown-notifications-list scrollable-container" >
                        <ul class="list-group list-group-flush">
                           <a href="<?=BASEURL?>admin/kycrequest">
                           ...
                           <a href="<?=BASEURL?>admin/payout_management">
                           ...
                           <a href="<?=BASEURL?>admin/pinrequesthistory">
                     ...
                     <div class="dropdown-menu-footer border-top p-2">
                        <a href="<?=BASEURL?>admin/viewnotification" class="btn btn-primary d-flex justify-content-center">
               ...
               <!--annoucement-->
               <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-2 me-xl-1">
                  <a  href="<?=BASEURL?>admin/announcement" class="nav-link btn btn-text-secondary rounded-pill btn-icon dropdown-toggle hide-arrow waves-effect waves-light"  aria-expanded="false">
               ...
               <!--end-->
               <!-- User -->
               <?php $admin=$this->db->where('username',$this->session->userdata('ablisusername'))->get('user_role')->row_array(); ?>
               <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                     <div class="avatar avatar-online">
                        <img src="<?=BASEURL?>assets/images/<?=$admin['profile_image']?>" alt class="w-px-40 h-auto rounded-circle" />
                     </div>
                  </a>
                  <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="#">
                           <div class="d-flex">
                              ...
                              <div class="flex-grow-1">
                                 <span class="fw-semibold d-block"><?=$admin['first_name']?> <?=$admin['last_name']?></span>
                     ...
                     <li>
                        <a class="dropdown-item" href="<?=BASEURL?>admin/user_profile">
                        <i class="mdi mdi-account-outline me-2"></i>
                        <span class="align-middle">My Profile</span>
                        </a>
                     </li>
                     <li>
                        <a class="dropdown-item" href="<?=BASEURL?>admin/invoice_list">
                     ...
                     <li>
                        <a class="dropdown-item" href="<?=BASEURL?>admin/logout_all_devices" >
