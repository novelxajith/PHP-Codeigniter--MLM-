 ...
 <div class="container-xxl flex-grow-1 container-p-y">  
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">      
                                              ...
                                              <h5 class="card-header">Team Incentive</h5>
                                             <div class="card-datatable table-responsive pt-0">
                                <table class="m-3" border="0" cellspacing="5" cellpadding="5">
                                    <tbody><tr>
                                        <form action="<?=BASEURL?>admin/team_incentive_filter" method="post">
                                            <td>From date:</td>
                        ...
                        ?>                           
                                                  <tr>
                                                     ...
                                                     <td><?=$i['admin_charge']+$i['credit'] +$i['tds']?></td>
...
$(document).ready(function () {
  ...
  $('#download-btn').on('click', function () {
    ...
    var headings = ['#','Date and Time', 'User ID', 'Username', 'Incentive', 'Admin Charge & TDS','Net Incentive'];
