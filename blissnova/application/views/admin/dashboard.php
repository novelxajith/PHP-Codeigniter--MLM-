...
<div class="content-wrapper">
   ...
   <?php $staff_type=$this->session->userdata('staffusertype'); ?>
            ...
            <div class="card">
               <div class="d-flex align-items-end row">
                  <div class="col-md-6 order-2 order-md-1">
                     <div class="card-body">
                        <?php $name=$this->db->where('username',$this->session->userdata('ablisusername'))->get('user_role')->row_array(); ?>
                                <?php 
