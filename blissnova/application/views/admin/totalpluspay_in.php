...
<div class="container-xxl flex-grow-1 container-p-y">
   <div class="row">
      <div class="col-12">
         <div class="card">
            <h5 class="card-header">Total Plus Pay In</h5>
            <form action="<?=BASEURL?>admin/totalpluspay_in" method="POST">
    ...
    <table id="example" class="display nowrap" style="width:100%"><button class="btn btn-primary w-md m-2" id="download-btn">Download as Excel</button>
        ...
        <tbody>
            ...
            <tr>
                ...
                <?php
                $actual=$key['pack_count']*$key['pack'];
                $gst=$actual*0.18;
                ?>
                <td><?=$actual?></td>
                 <td><?=$gst?></td>
...
$(document).ready(function () {
  ...
  $('#download-btn').on('click', function () {
    ...
    var headings = ['S.no','Date', 'Pin quantity', 'Amount', 'GST', 'Total amount'];
