   ...
   <div class="row">
      <div class="col-md-12">
        <ul class="nav nav-pills flex-sm-row mb-4">
          ...
          <li class="nav-item">
               <a class="nav-link active" href="<?=BASEURL?>admin/withdrawal_statement/<?=$user?>"
            ...
            <div class="card-datatable table-responsive pt-0">
               <table id="example" class="datatables-basic table table-bordered" style="width:100%">
                  <div class="tablerow m-3">
                     ...
                     <div class="col-lg-3">   
                        <button type="button" class="btn rounded-pill btn-primary waves-effect waves-light m-2 ">Submit</button>
                     </div>
                  </div>
                  <thead>
                     <tr>
