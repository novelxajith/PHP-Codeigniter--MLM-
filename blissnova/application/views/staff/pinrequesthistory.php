         ...
         <div class="card">
            ...
            <div class="card-datatable table-responsive pt-0">
               <table id="example" class="datatables-basic table table-bordered" style="width:100%">
                  ...
                  <tbody>
            <?php $pin_history=$this->db->where('status','Request')->get('investment')->result_array();
                  $count=1;
                   ...
                   $namee=$this->db->where('username',$pin['username'])->get('user_role')->row_array(); ?>
                     <tr>
                        ...
                        <td>
                          ...
                          <div class="m-1"><a onclick="showAcceptAlert(event, '<?=BASEURL?>staff/pin_accept/<?=$pin['id']?>')" href="#"  class="btn btn-success waves-effect waves-light" id="sa-warning">Accept</a></div>
                           <div class="m-1"><a onclick="showRejectAlert(event, '<?=BASEURL?>staff/pin_reject/<?=$pin['id']?>')" href="#" class="btn btn-danger waves-effect waves-light" id="ajax-alert">Reject</a></div>
                           </div>
                        </td>
                     </tr>
                <?php } ?>
                     ...
                     <tr>
                       ...
                       <?php }else{ ?>
                        ...
                        <?php } ?>
                          ...
                          <td><a href="<?=BASEURL?>staff/pinview/<?=$pinn['deposit_id']?>" <button type="button" class="btn btn-primary btn-sm" fdprocessedid="60z5ko">view</button></a></td>
                     </tr>
                    <?php }?> 
                  </tbody>
               </table>
