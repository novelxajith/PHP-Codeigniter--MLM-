                        ...
                        <?php $invoice_list=$this->db->get('invoice')->result_array();
                          ...
                          foreach($invoice_list as $key=>$invoice){ ?>
                                                  <tr>
                                                     ...
                                                     <td><a href="<?=BASEURL?>staff/invoice/<?=$invoice['id']?>"><button type="button" class="btn btn-primary btn-sm waves-effect waves-light" fdprocessedid="60z5ko">view</button></a></td>
                                                  </tr>
                                            <?php } ?>
                                               </tbody>
                                        </table>
