 ...
 <div class="container-xxl flex-grow-1 container-p-y">  
                      ...
                      <ul class="list-group list-group-flush">
                       ...
                       <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read waves-effect waves-light">
                         <div class="timeline-event">
                            ...
                            <div class="d-flex">
                            <a href="<?=BASEURL?>staff/view_announcement_pdf/<?=$ann['pdf']?>" rel="noopener noreferrer"> 
                ...
                <?php
                    ...
                    <div class="view more mt-2">
                         <a type="button" class="btn btn-primary waves-effect waves-light" href="<?=BASEURL?>staff/view_more_announce">
                        View more
                        </a>
                    </div>
