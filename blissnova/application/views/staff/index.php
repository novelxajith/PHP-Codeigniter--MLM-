      ...
      <div class="authentication-inner row m-0">
        ...
        <div
          ...
          <div class="w-px-400 mx-auto pt-5 pt-lg-0">
            ...
            <form id="formAuthentication" class="mb-3" action="<?=BASEURL?>staff/login" method="POST">
              <div class="form-floating form-floating-outline mb-3">
                ...
                <input
                  ...
                  value=""
                  autofocus oninput="this.value = this.value.charAt(0).toUpperCase() + this.value.slice(1)"/>
              ...
              <div class="mb-3 d-flex justify-content-between">
                ...
                <a href="<?=BASEURL?>admin/forgetpassword" class="float-end mb-1">
