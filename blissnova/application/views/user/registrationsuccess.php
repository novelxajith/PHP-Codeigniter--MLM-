                    ...
                    <div class="col-lg-12">
                        <div class="text-center mb-5 text-muted">
                            <a href="index.html" class="d-block auth-logo">
                                <img src="<?=BASEURL?>assets/images/logo-dark.png" alt="" height="20" class="auth-logo-dark mx-auto">
                                <img src="<?=BASEURL?>assets/images/logo-light.png" alt="" height="20" class="auth-logo-light mx-auto">
                            </a>
                                ...
                                <div class="p-2">
                                    <div class="text-center">
                                        ...
                                        <div class="p-2 mt-4">
                                            ...
                                            <div class="mt-4">
                                                <a href="<?=BASEURL?>user/index" class="btn btn-success">Go to User login</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
