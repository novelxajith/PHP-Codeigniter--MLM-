<?php include 'header.php';?>
 ...
 <div class="container-fluid">
                                    ...
                                    <div class="bg-primary bg-soft">
                                        <div class="row">
                                            ...
                                            <div class="col-5 align-self-end">
                                                <img src="<?=BASEURL?>assets/images/profile-img.png" alt="" class="img-fluid">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="pt-4">
                                                    ...
                                                    <div class="mt-4">
                                                        <a href="<?=BASEURL?>user/editprofile" class="btn btn-primary waves-effect waves-light btn-sm">Edit Profile <i class="mdi mdi-arrow-right ms-1"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
   ...
   <script src="<?=BASEURL?>assets/js/pages/profile.init.js"></script>
