      ...
      <div class="card">
         <div class="card-body">
            ...
            <div class="row mt-2 d-flex justify-content-center">
               ...
               <form action="<?=BASEURL?>user/plus_ceiling_achievers_filter" method="post">
               <div class="row mt-2 d-flex justify-content-center">
               ...
               <div class="row mt-3 new d-flex justify-content-center" id="items">
                   <?php 
                       foreach($rank_users as $user){
                            $coun = $this->db->group_by('username')->where('date(entry_date)',$user['entry_date'])->get('plus_rank_day')->result_array(); 
                              foreach($coun as $key){ ?>
           ...
           // echo $coun_wing1; echo $coun_wing2;
            ...
            $stars = $this->db->select_sum('counts')->where_in('username', array($key['username'],$left_sub_id,$right_sub_id))->get('plus_rank_day')->row()->counts; ?>
