        ...
        <div class="authentication-inner row m-0">
          ...
          <div
            ...
            <div class="w-px-400 mx-auto pt-5 pt-lg-0">
              ...
              <form id="formAuthentication" class="mb-3" action="<?=BASEURL?>user/reset_password" method="POST">
              <div class="mb-3 form-password-toggle">
                ...
                <div class="text-center">
                    <a href="<?=BASEURL?>user/forgetpassword" class="d-flex align-items-center justify-content-center">
                    <i class="mdi mdi-chevron-left scaleX-n1-rtl mdi-24px"></i>
                    Forgot Password
                  </a>
                  <a href="<?=BASEURL?>user" class="d-flex align-items-center justify-content-center">
                    <i class="mdi mdi-chevron-left scaleX-n1-rtl mdi-24px"></i>
                    Back to login
                  </a>
                </div>
