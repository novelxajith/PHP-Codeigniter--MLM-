    ...
    <?php echo $this->session->flashdata('success_message');  ?>
                              <div id="account-details" class="content">
                                 <div class="content-header mb-3">
                                  ...
                                  <form class="my-form" method="post" action="<?php echo base_url('user/register'); ?>">
                                 <div class="row g-4">
                                    ...
                                    <div class="col-sm-6">
                                      ...
                                      </div><span style="color:red;" id="username-error"></span>
                                    </div>
                                    <div class="col-sm-6">
                                    <div class="form-floating form-floating-outline mb-3">
                                        <input
                              ...
                              <div id="personal-info" class="content">
                                ...
                                <div class="col-sm-6">
                                       <div class="form-floating form-floating-outline">
                                          ...
                                          <input type="text" id="first-name" name="first_name"  value="" class="form-control" placeholder="John" />
                                    ...
                                    <div class="col-sm-6">
                                      <div class="form-floating form-floating-outline">
                                          ...
                                          <input type="text" id="last-name" name="last_name" value="" class="form-control" placeholder="Doe" />
  ...
  <div class="container">
    <div class="col-md-8 mt-4">
      ...
      <!--<input type="text" name="mobile" id="phone" />-->
        <input type="text"  id="phone" name="mobile"  value="8685212453" class="form-control" placeholder="Doe" />
    </div>
  </div>
...
<script>
   document.addEventListener("DOMContentLoaded", function() {
      ...
      function validateSection() {
        ...
        //     phonenumber.classList.add("error");
        //     $('#phone-error').text('Mobile number should be exactly 10 digits');
        //     return false;
        // } else {
        //     phonenumber.classList.remove("error");
        //     $('#phone-error').text('');
