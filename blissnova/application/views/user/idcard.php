...
<body>
    <?php  $id= $this->db->where('username',$this->session->userdata('ublisusername'))->get('user_role')->row_array(); ?>
        <div id="divToExport" class="container ">
                ...
                <div class="font m-2"  style=" background-color:white; background-size: cover;">
                    ...
                    <div class="bottom">
                     ...
                     <div class="barcode1">
                             <img alt='Barcode Generator TEC-IT' style="width:200px; height:50px;" 
       src='https://barcode.tec-it.com/barcode.ashx?data=<?=$this->session->userdata('ublisusername')?>&code=Code128&translate-esc=true&eclevel=L'/>
                        </div>
       ...
       src='https://barcode.tec-it.com/barcode.ashx?data=<?=$id['first_name']?>   <?=$id['last_name']?>,<?=$id['username']?>,<?=$id['address1']?>,<?=$id['pincode']?>,<?=$id['city']?>,<?=$id['district']?>,<?=$id['state']?>&code=MobileQRCode&translate-esc=true&eclevel=L'/>
       ...
       <div class="download" >
                    ...
                    <button  onclick="generatePDF()"  type="button" class="btn btn-primary waves-effect waves-light">Download</button>
                </div>
</body>
