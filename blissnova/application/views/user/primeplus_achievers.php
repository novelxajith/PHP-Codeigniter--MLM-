            ...
            <div class="row mt-2 d-flex justify-content-center">
               <div class="col-xl-6 col-lg-6 col-md-12 col-sm-8 col-12">
                  <div class="card h-100">
                       <?php
                           $counts = $this->db->select('counts')->where('username', $this->session->userdata('ublisusername'))->get('plus_rank')->row()->counts;
                     ...
                     <div class="card-body text-nowrap">
                        <h5 class="card-title mb-1 d-flex gap-1 flex-wrap">
               ...
               <div class="row mt-3 d-flex justify-content-center" id="items">
                   <?php $rank_achivers=$this->db->where('username !=',$this->session->userdata('ublisusername'))->get('plus_rank')->result_array(); 
               foreach($rank_achivers as $achivers) {
               ?>
                  <?php
                              $coun = $this->db->select('counts')->where('username', $achivers['username'])->get('plus_rank')->row()->counts;
