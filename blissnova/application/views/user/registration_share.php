                        ...
                        <div class="bs-stepper-content">
                              ...
                              <div id="account-details" class="content">
                                 <div class="content-header mb-3">
                                  ...
                                  <form id="myForm" class="my-form" method="post" action="<?php echo base_url('user/register'); ?>">
                                 <div class="row g-4">
                                    ...
                                    <div class="col-sm-6">
    <?php $name=$this->db->where('username',hex2bin($ref_id))->select('first_name')->get('user_role')->row()->first_name; ?>                                    
                                    <div class="form-floating form-floating-outline mb-3">
                                        <input
                                          type="text"
                                          class="form-control"
                                        ...
                                        <label for="username">Sponsor Name</label>
                                          ...
                                          <?php  $left_user = $this->db->select('username')->where('ref_id', hex2bin($ref_id))->where('user_type','sub')->where('position','left')->get('user_role')->row()->username;
      $right_user = $this->db->select('username')->where('ref_id', hex2bin($ref_id))->where('user_type','sub')->where('position','right')->get('user_role')->row()->username; ?>                            
                                    <div class="col-sm-6">
                                    <div class="form-floating form-floating-outline mb-4">
                                    <select class="form-select" name="ref_id" id="exampleFormControlSelect1" aria-label="Default select example">
                                        <option value="<?=hex2bin($ref_id)?>" id="center">Wing 1</option>
                                        <option value="<?=$left_user?>" id="left" >Wing 2</option>
                                        <option value="<?=$right_user?>" id="right">Wing 3</option>
                                    ...
                                    <div class="col-sm-6">
                                    <div class="form-floating form-floating-outline mb-4">
                                      <select class="form-select" name="position" id="exampleFormControlSelect1" aria-label="Default select example" >
                              ...
                              <div id="personal-info" class="content">
                                 ...
                                 <div class="row g-4">
                                  ...
                                  <div class="form-floating form-floating-outline">
                                       ...
                                       <span id="firstname-error" style="color:red;"></span><span style="color:red;">(As per Bank Passbook)</span>
                                    </div>
                                    <div class="col-sm-6">
                                       <div class="form-floating form-floating-outline">
                                       ...
                                       <span id="lastname-error" style="color:red;"></span><span style="color:red;">(As per Bank Passbook)</span>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-floating form-floating-outline mb-3">
                                              <input
                              ...
                              <div id="social-links" class="content">
                                 ...
                                 <div class="col-sm-6">
                                    ...
                                    <div class="mb-3 d-flex justify-content-between">
                                       ...
                                       <a href="https://demo-web-site.com/blissnova/newdev/dist" target="_blank">agree the terms & condition</a>
                                       </div>
                                    </div>
                                    <div class="col-12 d-flex justify-content-between">
                                       <a class="btn btn-outline-secondary btn-prev">
